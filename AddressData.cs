...
namespace NOBApp
{
    public static class AddressData
    {
        ...
        static int offsetValA = 27264;  //6A60
        ...
        public static string 快捷F8 = "5C3D5A2";
        ...
        public static string 選擇項目 = "96953C";
        public static string 選擇項目B = "969560";
        public static string 移動對象 = "969560";
        public static string 開始移動到目標對象 = "969558";
        public static string 頻道認證A = "5C48F5C";
        public static string 攝影機角度A = "5BB3CA4";    // 1 北 -1南 
        public static string 攝影機角度B = 攝影機角度A.AddressAdd(8); //1-西 -1 東
        //"A0 98" 戰鬥中
        //"F0 B8" 沒有任何視窗野外
        //"F0 F8" 開寶 出現對話框 戰鬥結束
        public static string 判別狀態A = "5C65240";
        //0 沒有畫面 7-第一頁面 8-輔助 C-技能 2奧義 -僅判斷
        public static string 戰鬥可輸入判斷 = "5BAF214";
        ...
        public static string 是否有觀察對象 = "4C534BC"; //沒有的話是 FFFFFFFF\ 4C4CA38
        public static string 直選框 = "4C54AB0";   //跳出選擇視窗[0~n選擇] ccTalkBox1
        public static string 製作Index = "4C4E171";   //製作完成會增加

        public static string 直選框文字 = "ADF184";      //確認選擇視窗文字 只會出現最後 ccTalkBox
        public static string 搜尋身邊NPCID起始 = "5C5DD24";
