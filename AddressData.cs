...
namespace NOBApp
{
    public static class AddressData
    {
        ...
        static int offsetValA = 0;
        public static string Acc = "5B6A928"; //5B69918
        public static string Pas = Acc.AddressAdd(21);
        public static string 角色名稱 = "4C4E220";
        public static string 地圖座標X = "5B6A5DC";
        public static string 地圖位置 = "4C4CC54";
        public static string 地圖座標H = 地圖座標X.AddressAdd(4);
        public static string 地圖座標Y = 地圖座標X.AddressAdd(8);
        public static string 快捷F8 = "5C34832";  //差222
        ...
        public static string 特殊狀態判斷 = "96DC24";  //win11的狀態
        public static string 直選框 = "4C4E018";   //跳出選擇視窗[0~n選擇] ccTalkBox1
        public static string 製作Index = "4C4E171";   //製作完成會增加

        public static string 直選框文字 = "ADA944";      //確認選擇視窗文字 只會出現最後 ccTalkBox
        public static string 搜尋身邊NPCID起始 = "5C54F24";
